defmodule PhxLiveStorybook.Stories.DocTest do
  use ExUnit.Case, async: true

  import ExUnit.CaptureLog

  alias PhxLiveStorybook.ExsCompiler
  alias PhxLiveStorybook.Stories.Doc
  ...
  describe "fetch_doc_as_html/2" do
    ...
    test "it returns [] when function doc has not yet been compiled" do
      ...
      assert log =~
               "could not fetch function docs from PhxLiveStorybook.Stories.DocTest.NoDocComponent"
    end
    ...
    test "it returns [] when live_component doc has not yet been compiled" do
      ...
      assert log =~
               "could not fetch module doc from PhxLiveStorybook.Stories.DocTest.NoDocLiveComponent"
    end
  end

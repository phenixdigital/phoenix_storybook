defmodule PhoenixStorybook.Stories.StoryValidatorTest do
  ...
  alias PhoenixStorybook.Story.StoryBehaviour
  alias PhoenixStorybook.{ComponentStub, LiveComponentStub, ExampleStub, PageStub}

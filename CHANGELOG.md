...
- **bugfix**: [iframe.js loads before storybook.js when using the module js type ](https://github.com/phenixdigital/phoenix_storybook/issues/657)
...
- **improvement**: bumped to `phoenix_live_view 1.0.10`
